...
<div id="resultat" class="table-responsive">
                ...
                <table id="mytabel" style=";" class="table" >
                    ...
                    <td>Période d'exercice : <?= $cands['peri_exe']; ?></td>
                    </tr>
                    
                    <tr>
                     <td>Téléphone 1 : <?= $cands['tel1'];  ?></td>
                    <td>Téléphone 2 : <?= $cands['tel2'];?></td>
                    <td>Email : <?= $cands['email']; ?></td>
                    </tr>
                  
                    <tr>
                     <td>Fonction à la CENI: <?= $cands['fnt_ceni'];  ?></td>
                    <td>Affiliation politique : <?= $cands['aff_p'];?></td>
                    <td>Poste candidat: <?= $cands['pst_cand']; ?></td>
                    </tr>

                    <tr>
                     <td>Période de scrutin: <?= $cands['peri_scru'];  ?></td>
                    <td>Poste Elu : <?= $cands['pst_cand'];?></td>
                    <td>Période de mandat : <?= $cands['peri_md']; ?></td>
                    </tr>
                    </tbody>
                </table>
            </div>
