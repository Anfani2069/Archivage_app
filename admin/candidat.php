...
$mov=  move_uploaded_file($file['tmp_name'], "C:\wamp\www\Projet\CENI\App\admin".'/img/cands/'.$name2);
...
if (isset($_GET['id'])) {
    ...
    $id = $db->quote($_GET['id']);
    $db->query("UPDATE candidat SET nom=$name, prenom=$prenom, dat_nais=$date, lieu_nais=$lieu, resi=$resi, img='$name2', ile=$ile, prof=$prof, fnt_ceni=$fonct, tel1=$tel1, tel2=$tel2, email=$email, peri_exe=$peri_ex, aff_p=$affil, pst_cand=$post_can, peri_scru=$peri_sc, pst_elu=$post_el, peri_md=$peri_ma WHERE id_cand=$id");
    ...
    $db->query("INSERT INTO candidat SET nom=$name, prenom=$prenom, dat_nais=$date, lieu_nais=$lieu, resi=$resi, img='$name2', ile=$ile, prof=$prof, fnt_ceni=$fonct, tel1=$tel1, tel2=$tel2, email=$email, peri_exe=$peri_ex, aff_p=$affil, pst_cand=$post_can, peri_scru=$peri_sc, pst_elu=$post_el, peri_md=$peri_ma");
    $_GET['id_cand'] = $db->lastInsertId();
}
                ...
                <input type="text" name="lieu" class="form-control" placeholder="" value="" required>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-6">
                          ...
                          <input type="text" name="affi" class="form-control" placeholder="" value="" required>
                         </div>
                     </div>
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-6">
                         ...
                         <input type="text" name="post_cand" class="form-control" placeholder="" value="" required> 
                        </div>
                       <div class="col-md-6">
                       <label for="peri_scr">Période de Scrutin</label>
                       <input type="text" name="peri_scr" class="form-control" placeholder="" value="" required>
                        </div>
                        </div>
                     ...
                     <div class="row">
                          ...
                          <div class="col-md-6">
                          <label for="post_elu">Poste Elu</label>
                          <input type="text" name="post_elu" class="form-control" placeholder="" value="" required> 
                          </div>
                          <div class="col-md-6">
                          <label for="peri_mand">Période de Mandat</label>
                          <input type="text" name="peri_mand" class="form-control" placeholder="" value="" required>
