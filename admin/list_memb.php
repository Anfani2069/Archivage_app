...
$db->query("DELETE FROM membre WHERE id_memb=$id");
            ...
            <div id="resultat" class="table-responsive">
                ...
                <table id="mytabel" class="table table-borded table-striped">
                    ...
                    <tr>
                        ...
                        <td><p class="hidden-print" data-placement="top" data-toggle="tooltip" tilte="Delete"><button class="btn btn-default btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-plus"></span><a style="text-decoration:none;" href="memb_detail.php?id=<?= $memb['id_memb']; ?>">Détails</a></button></p></td>
