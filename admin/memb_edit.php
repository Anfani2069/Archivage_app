...
if (isset($_GET['id'])) {
    ...
    $db->query("UPDATE membre SET nom=$name, prenom=$prenom, dat_nais=$date, lieu_nais=$lieu, resi=$resi, img=$img, ile=$ile, prof=$prof, fnt_ceni=$fonct, tel1=$tel1, tel2=$tel2, email=$email, peri_exe=$peri_ex, lieu_exe=$peri_ex, descri=$desc WHERE id_memb=$id ");
    header('Location: list_memb.php');
    die();
    
}else {
   
        $db->query("INSERT INTO membre SET nom=$name, prenom=$prenom, dat_nais=$date, lieu_nais=$lieu, resi=$resi, img=$img, ile=$ile, prof=$prof, fnt_ceni=$fonct, tel1=$tel1, tel2=$tel2, email=$email, peri_exe=$peri_ex, lieu_exe=$peri_ex, descri=$desc ");
...
<div class="container">
    ...
    <div class="col-md-12">
            ...
            <form action="#" class="formulaire" method="POST"> 
                        ...
                        <input type="text" name="name" class="form-control" placeholder="" value="<?= $membs['nom'] ;?>" required>
                        </div>
                        <div class="col-md-6">
                        <label for="prenom">Prenom</label>
                        <input type="text" name="prenom" class="form-control" placeholder="" value="<?= $membs['prenom'] ;?>" required>
                        </div>
                        </div>
                        ...
                        <input type="date" name="date" class="form-control"  placeholder="" value="<?= $membs['dat_nais'] ;?>" required>  
                        </div>
                        <div class="col-md-6">
                        <label for="lieu">Lieu de naissance</label>
                        <input type="text" name="lieu" class="form-control" placeholder="" value="<?= $membs['lieu_nais'] ;?>" required>
                        </div>
                        </div>
                        ...
                        <input type="text" name="resi" class="form-control" placeholder="" value="<?= $membs['resi'] ;?>" required>
                        </div>
                        <div class="col-md-6">
                         <label for="ile">Ile</label>
                         <select class="form-control" name="ile" value="ile" required>
                            <option><?= $membs['ile'] ;?></option>
                        ...
                        <div class="md-3">
                         ...
                         <input type="text" name="prof" class="form-control" placeholder="" value="<?= $membs['nom'] ;?>" required>
                        </div>

                         <div class="row">
                         <div class="col-md-6">
                            <label for="lieu_ex">Lieu d'exercice</label>
                            <input type="tel" name="lieu_ex" class="form-control" placeholder="" value="<?= $membs['lieu_exe'] ;?>" required>
                        </div>
                         <div class="col-md-6">
                           <label for="peri">Periode d'exercice</label>
                           <input type="text" name="peri" class="form-control" placeholder="2015-2016" value="<?= $membs['peri_exe'] ;?>" required>
                          </div>
                          </div>
                          ...
                          <div class="col-md-6">
                           ...
                           <input type="text" name=tel1 class="form-control" placeholder="" value="<?= $membs['tel1'] ;?>" required> 
                          </div>

                          <div class="col-md-6">
                           <label for="tel2">Telephone 2</label>
                           <input type="text" name="tel2" class="form-control" placeholder="" value="<?= $membs['tel2'] ;?>" required>                
                          </div>
                          </div>
                          ...
                          <input type="email" name="email" class="form-control" id="email" value="<?= $membs['email'] ;?>" placeholder="you@example.com"> 
                         </div>
                     ...
                     <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <input type="text" name="fonct" class="form-control" placeholder="" value="<?= $membs['fnt_ceni'] ;?>" required>
                           </div>

                           <div class="col-md-6">
                          <label for="desc">Description</label>
                          <textarea type="text" name="desc" class="form-control" placeholder="" value="" required><?=$membs['descri']; ?> </textarea>
                          </div>
                     ...
                     <img src="img/membs/<?= $membs['img'] ;?>" alt="image" style="margin-top:12px; margin-left:20px;" width="" height="200">
                         
                          <div class="custom-file" >
                            <input type="file" name="img" style="margin-left:20px;" class="custom-file-input"  placeholder="" required>
