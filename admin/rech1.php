...
if (isset($_GET['critere'])) {
    ...
    if (count($table)>0) {
      ...
      <table id="mytabel" class="table table-borded table-striped">
                           ...
                           <tr>
                               ...
                               <td><p class="hidden-print" data-placement="top" data-toggle="tooltip" tilte="Delete"><button class="btn btn-default btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-plus"></span><a style="text-decoration:none;" href="cand_detail.php?id=<?= $cand['id_cand']; ?>">Details</a></button></p></td>
    ...
    $req=$db->query("SELECT * FROM candidat");
